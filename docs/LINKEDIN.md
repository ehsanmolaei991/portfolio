...
Copy these into LinkedIn. Recruiters search LinkedIn first, so keep the **title and
top skills identical to your résumé** (`Senior Frontend Engineer`). Turn on
**Open to work → relocation**, and set your location to your target region if allowed.
...
> Senior Frontend Engineer & Team Lead · React / Next.js / TypeScript · Open to EU relocation & visa sponsorship

## About

I'm a Senior Frontend Engineer and Team Lead with 9+ years shipping web and mobile products across fintech, automotive, and SaaS. I specialize in React, Next.js, React Native, and TypeScript, and I care most about what users feel but never see: a clean component architecture and a design system the whole team can move fast on — the foundation behind fast, accessible interfaces.
...
4. React Native
5. Design Systems
6. Frontend Architecture (Monorepos)
7. State Management (Redux, Zustand, RTK Query)
